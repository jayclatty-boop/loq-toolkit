...
public partial class MainWindow
{
    ...
    private void UpdateIndicator_Click(object sender, RoutedEventArgs e)
    {
        try
        {
            ...
            {
                FileName = "https://github.com/BartoszCichecki/LenovoLegionToolkit",
    ...
    {
        // Updates disabled - show GitHub message
        Dispatcher.Invoke(() =>
        {
            _updateIndicatorText.Text = "This version will be updated via GitHub, please check the repo";
